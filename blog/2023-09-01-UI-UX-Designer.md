...
## A. Mô tả công việc
- Phối hợp, thiết kế giao diện ứng dụng: xây dựng low & high fidelity wireframe, visual design và design prototype.
- Tìm hiểu insight về user từ dữ liệu market, industry trends, competitive analysis & user experience research.
- Phối hợp với các thành viên khác trong đội phát triển sản phẩm để đưa ra các sản phẩm chất lượng cao.
- Đảm bảo chất lượng sản phẩm theo các yêu cầu về design.
 
## B. Yêu cầu ứng viên
- Có kinh nghiệm từ 06 tháng đến 01 năm làm việc tại vị trí tương đương, đã tham gia vào các dự án thực tế.
...
- Thu nhập: **CẠNH TRANH lên đến 15.000.000 đồng/ tháng**.
